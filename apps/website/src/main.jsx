...
function App(){const loc=useLocation();useEffect(()=>{const titles={'/':'AI魔法学院 · 青少年 AI 创作开课平台','/marketplace':'课程广场 · AI魔法学院','/courses':'课程体系 · AI魔法学院','/org':'机构方案 · AI魔法学院','/works':'学员作品 · AI魔法学院','/handbook':'产品手册 · AI魔法学院','/compare':'选型对比 · AI魔法学院','/download':'下载说明 · AI魔法学院','/demo':'预约演示 · AI魔法学院','/terms':'用户协议 · AI魔法学院','/privacy':'隐私政策 · AI魔法学院','/minors':'儿童 / 未成年人说明 · AI魔法学院'};document.title=titles[loc.pathname]||titles['/'];const description=document.querySelector('meta[name=description]');if(description)description.setAttribute('content','面向教培机构与学校的青少年 AI 通识与 VibeCoding 开课平台。');const canonical=document.querySelector('link[rel=canonical]');if(canonical)canonical.setAttribute('href',window.location.origin+(loc.pathname==='/'?'':loc.pathname));const ogTitle=document.querySelector('meta[property="og:title"]');if(ogTitle)ogTitle.setAttribute('content',titles[loc.pathname]||titles['/']);const ogUrl=document.querySelector('meta[property="og:url"]');if(ogUrl)ogUrl.setAttribute('content',window.location.origin+(loc.pathname==='/'?'':loc.pathname));},[loc.pathname]);return <div className="site"><Header/><Routes><Route path="/" element={<Home/>}/><Route path="/marketplace" element={<Marketplace/>}/><Route path="/marketplace/:id" element={<MarketplaceDetail/>}/><Route path="/courses" element={<Courses/>}/><Route path="/org" element={<Org/>}/><Route path="/works" element={<Works/>}/><Route path="/handbook" element={<Handbook/>}/><Route path="/compare" element={<Compare/>}/><Route path="/download" element={<Download/>}/><Route path="/demo" element={<Demo/>}/><Route path="/terms" element={<LegalPage type="terms"/>}/><Route path="/privacy" element={<LegalPage type="privacy"/>}/><Route path="/minors" element={<LegalPage type="minors"/>}/><Route path="*" element={<Home/>}/></Routes><Footer/></div>};
