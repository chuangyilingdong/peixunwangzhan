...
| 优先级 | 事项 | 说明 |
|---|---|---|
| P0 | P9-I01～P9-I04 内测部署、安全访问、数据隔离、备份回滚 | 先让内部测试环境安全可用，不等待备案 |
| P0 | P9-I05 内部 UAT | 平台、机构管理员、教师、学生、官网访客主流程验收 |
| P1 | P9-I06 内测运行手册与日志 | 确保内部测试可启动、可观察、可恢复 |
| P1 | P8-Q03 / P8-S02 / P8-S03 / P8-L01 | 与内测并行补 API 回归、会话安全、租户隔离、数据最小化 |
| 外部阻塞 | P5-W09 / P5-W10、真实 AI / OSS / 支付 / 微信等 | 不阻塞内测；没有业务方账号、主体或规则时不得伪造 |
