...
| P1 | P8-Q01 / P8-Q02 / P8-Q05、P8-L02～P8-L06 | 代码质量、单元测试、跨浏览器 / 移动端回归、未成年人和内容治理 |
...
P8-S06 发布、回滚与事故响应演练已通过；下一步等待 registry 恢复后完成 P8-S01 依赖漏洞扫描，并推进 P8-Q01 / Q02 / Q05 与 P8-L02～L06；线上 `https://iicili.cyou/` 继续保持 noindex、独立测试数据库和内测标识；Basic Auth 已按用户授权解除，正式公开前必须恢复访问控制。