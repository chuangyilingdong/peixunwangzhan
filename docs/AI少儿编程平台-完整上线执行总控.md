...
2. **P9-D01：当前执行。** 生产部署架构 ADR 草案见 `docs/p9/P9-D01-production-architecture-ADR.md`，等待用户确认 SQLite 起步、域名、访问控制与是否建立 production 环境。
3. **P9-D02～P9-D05：待 P9-D01 确认后执行。** 依次完成环境隔离、CI/CD、密钥发布机制、反向代理 / HTTPS / 域名 / CORS / 安全头。
