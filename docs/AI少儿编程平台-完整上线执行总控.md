...
- [ ] **下一会话推荐：P5-W08 协议 / 隐私 / 未成年人说明。**
  ...
  - 其他开放项：P5-W01 / P5-W07 / P5-W09 / P5-W10（见 §5.1 + §5.2）；P5-W03/W06 已产品决策取消（见对应 todo 行的 `[~]` 标记）；外加 `/org/afee` 阿飞提醒（外部决策微信）、`/org/enrollment` 学员订单（已被 P4-O07 实际覆盖，建议文档改判"真实已有"）、`/demo` 预约演示（已被 P5-W02 实际覆盖，建议改判"真实已有"）。
