...
- [ ] **当前唯一执行队列：完成生产 24 小时运行观察（截止 2026-09-05 20:24:38 CST），随后进入线下机构交付验收。**
  ...
  - 观察结束后，优先验收“平台创建机构 → 机构创建教师/学生 → 分班/授权 → 教学闭环”的真实交付流程。
...
- [-] **P9-R05 上线后 7 / 30 天观察与复盘（进行中）**
  - 优先级：P0
  - 进度：24 小时观察已于 2026-09-04 20:24 CST 开始，记录见 `docs/p9/P9-D02-production-24h-observation.md`；每日 03:00 备份 timer 待 2026-09-05 首次自动执行复核。
  - 验收：7 / 30 天复盘需覆盖错误率、性能、AI 成本（当前 local-mock 不产生真实模型成本）、工单、投诉、转化、内容审核与备份，并形成问题清单、优先级和负责人；窗口未结束前不得宣称完成。
- [-] **P9-R06 运营与技术交接包**
  - 优先级：P0
