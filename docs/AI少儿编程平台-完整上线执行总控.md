...
- [x] **P9-D05 反向代理、HTTPS、域名、CORS 与安全头** ✅ 2026-09-04
  - 优先级：P0
  ...
  - 安全加固：敏感扫描路径返回 404，移除 default 站点，ufw 默认 incoming deny 且仅放行 22/80/443；旧 8787 已清除。internal-test 8788 仅作为本机回滚资产，不在公网放行。
