...
- [-] **当前执行队列：完成线下机构真实交付闭环验收与上线发布准备。**
  - 流程：平台创建机构 → 机构管理员创建教师 / 学生 → 教师创建班级 → 教师加入学生 → 教师配置已授权课程 / 课时 → 教师开课 → 学生学习、创建并提交项目 → 教师查看并点评作品。
  - 已完成：教师班级职责代码与 9/9 专项验收；P8-Q03 52/52、P8-Q04 54/54、P4-C01 27/27、P4-01 28/28、P4-03 50/50、P8-Q02 17/17、P8-Q06 13/13；四端生产构建通过。
  - 下一步：修正旧权限回归脚本、完成全量隔离回归和交付证据归档；确认本次 commit 与生产 release 的发布关系后再执行生产发布。
### 2026-09-05 用户职责边界确认
