...
> 那一份写清了**当前生产状态**（release **20260921T035517Z** / commit **8c607f0**、五入口 200、
> `PROD_ACCEPTANCE_OK`、广场 205 件、磁盘 58%、release 10 份）与这一轮做的一件事：
...
> ⭐ **发布按 HEAD 走，会把别人"还没打算部署"的提交一起带上线**（这次就带上了另一个会话的客户端更新，
> 见那一份 §二.E —— 发布前先 `git log origin/<branch> -3` 看清 HEAD 里都有谁的东西）。
>
