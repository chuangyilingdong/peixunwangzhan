...
> 版本：2026-09-17（第十三轮 · 课堂改造 + 素材预览 + 工作台与课包库存）
> **⚠️ 新会话先读** `docs/operations/新对话交接-第十三轮梳理-20260917.md` ——
> 那一份把**第十三轮的五条线**串起来（课堂按线框图改造 / 后台字体 / 教学素材预览 /
> **学生环境被 OOM 杀掉的事故** / 工作台与机构课包库存），并给出**当前生产的确切状态**
> （release `20260917T105252Z` / commit `d6e432e`）、三件「现在别做」、以及这一轮挖出来的
> **七条判断口径**（几条是花了半天才挖出来的）。
>
> 里面最值钱的两条，先记在这里：
...
> · `新对话交接-机构课包库存与授权-计划.md`（002 六屏的施工图与数据契约；**002-03/04/06 还没做**）
>
