...
代码提交：231607d（本地 HEAD = origin，已推送；**生产版就是它**）
生产：release 20260918T104730Z / commit 231607d（服务 learning-platform-production @127.0.0.1:8789）
      本版改动（231607d）：**灵动课程按用户第二轮口径改四处**（用户看完实际页面提的）
