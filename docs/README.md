...
> 版本：2026-09-18（第十四轮 · 平台机构与授权次数 + AI 配置重做；**下一步开始做官网**）
> **⚠️ 新会话先读** `docs/operations/新对话交接-第十四轮-官网改动前-20260918.md` ——
> 那一份把**当前生产状态**、**这一轮做了什么**、**不许破的五条口径**（尤其：平台侧只有"授权次数"没有
> "算力额度"、额度只观测不拦人、内部成本口径不上公开面）、**官网这块现在长什么样与动它的三个坑**、
> 以及还欠着的事串在一起，并指向各条线的细节交接。
