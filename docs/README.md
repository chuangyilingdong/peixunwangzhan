...
> 版本：2026-09-19（第二十一轮 · 官网收口 + 课时/画布微调）
> **⚠️ 新会话先读** `docs/operations/新对话交接-第二十一轮-官网收口与画布微调-20260919.md` ——
> 那一份写清了**当前生产状态**（release **20260919T140543Z** / commit **e8f987c**、五入口 200、
> 广场 **205 件**、媒体 1.7GB、CMS 现有键），**这一段做了什么**（⭐ 抓 aimagc.cn 那 9 件静态网页作品上广场 /
> ⭐ 后台作品编辑 + 软删/彻底删除两档 + 分类映射表单 / ⭐ 常见问题空档位隐藏 + 档位后台可排优先级 /
> ⭐ 机构手册按设计稿整页重做（图自托管、海报就位）/ ⭐ 删掉「灵动介绍」整页与其导航 /
> ⭐ 课时去掉三栏表单 + 画布框体没生成时能删 + 未生成占位图换新插画）、
> **不许破的口径**（口径 1–6 在第二十轮那份、**7–24 在这一份**）、**结构与关键文件**、
> **下一步**（aimagc 若还有别处的作品需用户给清单、客户端那三件、老欠账、**三处"没验到"的**），
> 以及**这一段踩过的坑 12–36**（加上第二十轮的 1–11 共 36 个）+ 怎么跑 p115 / p120 / p121 / p122 四道守卫。
