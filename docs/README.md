...
> 版本：2026-09-19（第二十轮 · 作品广场重做 + 导入 476 件 + 抓 aimagc 9 件网页作品 + 后台编辑/删除 + 分类表单 + 常见问题档位 + 配色收口）
> **⚠️ 新会话先读** `docs/operations/新对话交接-第二十轮-作品广场与导入-20260919.md` ——
> 那一份写清了**当前生产状态**（release **20260919T121313Z** / commit **32cbad0**、五入口 200、
...
> **不许破的口径**（第十五～十九轮 25+ 条 ＋ 本轮新增 **14** 条）、**结构与关键文件**、
> **下一步**（aimagc 若还有别处的作品需用户给清单、客户端那三件、老欠账），
> 以及**这一轮踩过的 26 个坑**（含怎么跑 p115 / p120 / p121 三道守卫）。
> 其中五条最值钱：⭐ **`.mov` 的容器品牌 `ftypqt` 浏览器播不了**（改 MIME/去 nosniff 都没用，
