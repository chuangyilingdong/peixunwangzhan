...
> 那一份写清了**当前生产状态**（release **20260919T123208Z** / commit **31e7522**、五入口 200、
...
> **不许破的口径**（第十五～十九轮 25+ 条 ＋ 本轮新增 **16** 条）、**结构与关键文件**、
> **下一步**（aimagc 若还有别处的作品需用户给清单、客户端那三件、老欠账），
> 以及**这一轮踩过的 31 个坑**（含怎么跑 p115 / p120 / p121 三道守卫）。
> 其中六条最值钱：⭐ **`.mov` 的容器品牌 `ftypqt` 浏览器播不了**（改 MIME/去 nosniff 都没用，
