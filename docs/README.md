...
代码提交：067113a（本地 HEAD = origin，已推送；**生产版就是它**）
生产：release 20260918T130755Z / commit 067113a（服务 learning-platform-production @127.0.0.1:8789）
      本版改动（067113a）：**画布「复制」按钮与结果框对齐** —— 按钮是按外层 wrapper 绝对定位的，
