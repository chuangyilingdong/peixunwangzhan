...
代码提交：1f36b05（本地 HEAD = origin，已推送；**生产版就是它**）
生产：release 20260918T112017Z / commit 1f36b05（服务 learning-platform-production @127.0.0.1:8789）
      本版改动（1f36b05，用户第三轮口径四条）：**灵动课程只留两个分类 / 灵动作品换搜索 + 卡片照 zip 重做**
